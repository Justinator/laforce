    ...
    <div class="container-wide">
      <div class="featured-project-content w-100 w-50-l lane">
        <div class="featured-project-inner">
          ...
          <p><a href="<?php echo get_field("project_link"); ?>" class="btn-fill-alt fill-alt" aria-label="<?php echo get_field("project_link_text"); ?>: <?php echo get_field("project_title"); ?>"><?php echo get_field("project_link_text"); ?></a></p>
        </div>
      </div>
    </div>
  </div>
