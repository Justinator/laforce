...
function insightcustom_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('your_secondary_logo');
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'your_secondary_logo',
	array(
	'label' => 'Secondary Logo',
	'section' => 'title_tagline',
	'settings' => 'your_secondary_logo',
	) ) );
